	...
	public static void main(String[] args) {
		...
		generateReports(model3Sales, "Model 3");
		 ...
		 public static void generateReports(List<SalesRecord> salesRecords, String modelName) {
		        ...
		        Map<Integer, Integer> yearlySalesMap = salesRecords.stream()
		        ...
		        SalesRecord bestMonth = salesRecords.stream()
		                .max(Comparator.comparingInt(SalesRecord::getSales))
		                .orElse(null);
		        SalesRecord worstMonth = salesRecords.stream()
...
//															   ));
//			
////			Map<Integer, Integer> monthlySalesMap = salesRecords.stream()
