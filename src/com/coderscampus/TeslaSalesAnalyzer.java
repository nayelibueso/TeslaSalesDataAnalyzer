	...
	public static List<SalesRecord> readSalesData(String fileName) {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = br.readLine()) != null) {
            	...
            	String[] parts = line.split(" ", 2); //S[lits current line into two parts based on the first space encountered
                ...
                try {
                    YearMonth date = YearMonth.parse(dateStr, formatter); //Parses to YearMonth object and uses predefined formatter 
